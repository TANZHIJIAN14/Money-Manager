...
public class MainTransactionCardAdapter extends RecyclerView.Adapter<MainTransactionCardAdapter.MyViewHolder> {

    Context context;
    List<transaction> transactionCardList;

    public MainTransactionCardAdapter(Context context, List<transaction> transactionCardList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new MainTransactionCardAdapter.MyViewHolder(view);
    }
